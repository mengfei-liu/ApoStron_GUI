...
Rectangle
{
    ...
    //property int movePos: container.objectName === "input_both" ? -70 : (container.objectName === "input_distance" ? -35 : -33)

    //property int movePos: container.objectName === "input_both" ? -5 : (container.objectName === "input_distance" ? 25 : 5) //simple input

    property int movePos: container.objectName === "input_both" ? -45 : (container.objectName === "input_distance" ? 25 : (container.objectName === "input_angle" ? -20 : 5)) //add ccw
    ...
    onHaveSignChanged:
    {
        ...
        {
            key_sign.text = "±"
            key_sign.enabled = true
        }
        else
        {
            key_sign.text = ""
            key_sign.enabled = false
        }
    }
   ...
   // Kb_Num_Btn{anchors.top:row_func.top; anchors.right: root.right;text:"Done";onBtnClick: {root.state = "inactive";}}//btn_cancel.enabled = true;btn_next.enabled = true;}}
    ...
    ColumnLayout
    {
        ...
        Row
        {
            ...
            Kb_Num_Btn{id:key_sign;text:"±";btnOperator:text; Component.onCompleted: btnClick.connect(buttonPressed)}
